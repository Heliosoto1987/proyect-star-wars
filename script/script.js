...
const arrayphotos = [
    ...
    function menu2(menu) {
        menu.classList.toggle('lol')
            if(menu.classList.contains('lol')){
            menu.innerHTML += `<span class="menu2__span">Lord Venao</span>` + '<span class="menu2__span">Perfect Jedi</span>' + '<span class="menu2__span">Momy Joda</span>' + '<span class="menu2__span">Dark senior</span>' + '<span class="menu2__span">Padawan</span>' +'<span class="menu2__span">El campeon</span>'
            }else{
    ...
    function activate2(event) {
        const select = event.target.innerHTML;
            if (select === 'Lord Venao') {
                reciver.innerHTML = `<div class="name">Nombre: Lord Venao</div>` + `<div class="height">Altura: 1.69</div>` + `<div class="mass">Peso: Incalculable</div>` + `<div class="img"><img class="img__inside" src="img/papa123.jpg" alt="Disculpe ha ocurrido un error"></div>` + `<div class="reciver__text">Este terrible Jedi es un peligro para las reservas de azucar en el mundo</div>`;
                ...
                reciver.innerHTML = `<div class="name">Nombre: Hermano querido</div>` + `<div class="height">Altura: 1.75</div>` + `<div class="mass">Peso: No sale de 75Kg</div>` + `<div class="img"><img class="img__inside" src="img/padawan.jpg" alt="Disculpe ha ocurrido un error"></div>` + `<div class="reciver__text">Buscando la felicidad</div>`;
            }else if (select === 'Dark senior') {
                reciver.innerHTML = `<div class="name">Nombre: Dark Senior</div>` + `<div class="height">Altura: 2.03</div>` + `<div class="mass">Peso: 145Kg</div>` + `<div class="img"><img class="img__inside" src="img/ale.jpg" alt="Disculpe ha ocurrido un error"></div>` + `<div class="reciver__text">Pontente Senior Front End... </div>`;
            ...
            }else if (select === 'El campeon') {
                reciver.innerHTML = `<div class="name">Nombre: Jedi Front End</div>` + `<div class="height">Altura: 1.85</div>` + `<div class="mass">Peso: 115kg</div>` + `<div class="img"><img class="img__inside" src="img/helio.jpg" alt="Disculpe ha ocurrido un error"></div>` + `<div class="reciver__text">Campeon de la galaxia</div>`;
